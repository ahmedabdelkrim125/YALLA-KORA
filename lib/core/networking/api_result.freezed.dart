...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( T data)?  success,TResult Function( ErrorHandler apiErrorHandler)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Success() when success != null:
return success(_that.data);case Failure() when failure != null:
return failure(_that.apiErrorHandler);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( T data)  success,required TResult Function( ErrorHandler apiErrorHandler)  failure,}) {final _that = this;
switch (_that) {
case Success():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( T data)?  success,TResult? Function( ErrorHandler apiErrorHandler)?  failure,}) {final _that = this;
switch (_that) {
case Success() when success != null:
return success(_that.data);case Failure() when failure != null:
return failure(_that.apiErrorHandler);case _:
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('apiErrorHandler', apiErrorHandler));
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Failure<T>&&(identical(other.apiErrorHandler, apiErrorHandler) || other.apiErrorHandler == apiErrorHandler));
}
...
/// Create a copy of ApiResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? apiErrorHandler = null,}) {
  return _then(Failure<T>(
null == apiErrorHandler ? _self.apiErrorHandler : apiErrorHandler // ignore: cast_nullable_to_non_nullable
as ErrorHandler,
  ));
}
