...
class _ApiService implements ApiService {
  ...
  @override
  Future<SignupResponse> register(SignupRequestBody registerRequestBody) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<ApiResponseModel<BookingData>> createBooking({
    ...
    final _options = _setStreamType<ApiResponseModel<BookingData>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'bookings',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponseModel<BookingData> _value;
    try {
      _value = ApiResponseModel<BookingData>.fromJson(
        _result.data!,
  ...
  @override
  Future<ApiResponseModel<JoinMatchResponse>> joinMatch({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponseModel<JoinMatchResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponseModel<JoinMatchResponse> _value;
    try {
      _value = ApiResponseModel<JoinMatchResponse>.fromJson(
        _result.data!,
        (json) => JoinMatchResponse.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
