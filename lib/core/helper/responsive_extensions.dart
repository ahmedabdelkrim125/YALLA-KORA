...
extension ResponsiveExtension on BuildContext {
  ...
  double responsiveWidth(double mobileValue, {double? tabletValue, double? desktopValue}) {
  ...
  double responsiveHeight(double mobileValue, {double? tabletValue, double? desktopValue}) {
    if (isDesktop && desktopValue != null) {
      return desktopValue;
    } else if (isTablet && tabletValue != null) {
      return tabletValue;
  ...
  EdgeInsets responsivePadding({
    ...
    return EdgeInsets.only(
      top: top != null ? responsiveHeight(top) : (vertical != null ? responsiveHeight(vertical) : (all != null ? responsiveHeight(all) : 0)),
      bottom: bottom != null ? responsiveHeight(bottom) : (vertical != null ? responsiveHeight(vertical) : (all != null ? responsiveHeight(all) : 0)),
      left: left != null ? responsiveWidth(left) : (horizontal != null ? responsiveWidth(horizontal) : (all != null ? responsiveWidth(all) : 0)),
      right: right != null ? responsiveWidth(right) : (horizontal != null ? responsiveWidth(horizontal) : (all != null ? responsiveWidth(all) : 0)),
    );
  }
}
